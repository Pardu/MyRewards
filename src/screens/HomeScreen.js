...
const styles = StyleSheet.create({
  ...
  tabsContent: {
    backgroundColor: colors.white, paddingHorizontal: SPACING * 2,
    height: Platform.OS === 'ios' ? height - (SPACING * 19) : height - (SPACING * 14),
    width: Platform.OS === 'ios' ? width : width - SPACING
  },
  modalBtn: {
